...
\begin{document}	
	% première page
	\input{chapitres/PremierePage.tex}
	...
	%\section{Partie 1}
	\input{chapitres/DatasetStudy.tex}
	%\section{Partie 2}
	\input{chapitres/ModelChoice.tex}
	%\section{Partie 3}
	\input{chapitres/GlobalPerformance.tex}
	%\section{Partie 4}
	\input{chapitres/Probleme.tex}
	%\section{Partie 5}
	%\input{chapitres/Partie_5.tex}
	%\section{Partie 6}
	%\input{chapitres/Partie_6.tex}
	%\section{Conclusion}
	%\input{chapitres/Conclusion.tex}
	%\section{Code}
	%\input{chapitres/Code.tex}
