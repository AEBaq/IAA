...
\begin{itemize}
  \item Chargement depuis le meilleur checkpoint : le fine-tuning repart de best\_model.pt via init\_and\_load, garantissant que les poids de départ sont optimaux.
  ...
  \item Split aléatoire : le dataset réel est divisé aléatoirement en 80\% train et 20\% val via train\_test\_split, évitant le biais d'un split séquentiel qui aurait pu concentrer les virages dans un seul split.
\end{itemize}
