...
\begin{itemize}
  ...
  \item Gel partiel conservé : seuls layer4 et fc restent entraînables, les couches basses étant gelées. Avec seulement 7 198 échantillons réels, entraîner toutes les couches risquerait de causer un overfitting et d'effacer les features générales apprises sur ImageNet.
